...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Obx(
        () => Scaffold(
          body: controller.book.isEmpty
              ? CircularProgressIndicator()
              : SingleChildScrollView(
                  scrollDirection: Axis.vertical,
                  child: Padding(
                    padding: const EdgeInsets.only(
                        top: 50.0, bottom: 80.0, right: 20.0, left: 20.0),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        // searchBar(context),
                        header(context, "Nabil"),
                        Padding(
                          padding:
                        ...
                        bookCard(
                            context, "Laskar's Favorite", controller.book[3]),
                        bookCollection(
                            context, "Recently Read", controller.book),
                      ],
                    ),
                  ),
                ),
